...
downloadHsp =
    <div id="main">
        ...
        <p>The current client is available as binary for linux (i686 and x86_64, build on Arch Linux) and as source code.</p>
        <ul>
        ...
        <p>There is also an Arch Linux package: <a href="http://aur.archlinux.org/packages.php?ID=33345">aur/npaste-client</a></p>

        <h2>Usage:</h2>
        <pre><%     "$ np <file>                  # upload a file\n"
                ++  "$ np                         # read from stdin\n"
                ++  "$ np -f <filetype> <file>    # define a custom filetype (default: look for file extension or use \"plaintext\")\n"
